...
goog.provide("app.common.svg.arc_to_curve");

// https://raw.githubusercontent.com/fontello/svgpath/master/lib/a2c.js
goog.scope(function() {
    const self = app.common.svg.arc_to_curve;
    ...
    //
    function getArcCenter(x1, y1, x2, y2, fa, fs, rx, ry, sin_phi, cos_phi) {
        // Step 1.
        //
    ...
    //
    function approximateUnitArc(theta1, delta_theta) {
    ...
    function a2c(x1, y1, x2, y2, fa, fs, rx, ry, phi) {
        ...
        for (var i = 0; i < segments; i++) {
            result.push(approximateUnitArc(theta1, delta_theta));
            theta1 += delta_theta;
        }
